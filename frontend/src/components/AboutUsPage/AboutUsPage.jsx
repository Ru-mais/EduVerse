        ...
        <div className={aboutUsStyles.sectionGrid}>
          <div className={aboutUsStyles.valuesHeader}>
            ...
            <p className={aboutUsStyles.valuesSubtitle}>
              The foundation of everything we do at EduVerse
            </p>
          </div>
...
<div className="group perspective">
  <div className="relative transition-transform duration-500 ease-out group-hover:rotate-x-6 group-hover:-rotate-y-6">

    {/* Gradient ring */}
    <div className="absolute -inset-[3px] rounded-full bg-gradient-to-r from-blue-500/40 to-teal-500/40 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>

    {/* Avatar */}
    <div className="relative w-28 h-28 rounded-full overflow-hidden bg-white shadow-lg group-hover:shadow-xl transition-shadow duration-500">
      <img
        src={member.image}
        alt={member.name}
      ...
      <section className={aboutUsStyles.ctaSection}>
        ...
        <div className={aboutUsStyles.ctaContent}>
          ...
          <p className={aboutUsStyles.ctaDescription}>
            ...
            EduVerse. Start your journey today with a 7-day free trial.
          </p>
