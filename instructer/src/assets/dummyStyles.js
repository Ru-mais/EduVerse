...
//istructor page
export const instructorWelcomeStyles = {
  container:
    "flex items-center justify-center min-h-[70vh] px-4",

  card:
    "w-full max-w-2xl bg-white border border-gray-200 rounded-2xl p-8 sm:p-10 text-center shadow-sm",

  title:
    "text-2xl sm:text-3xl font-semibold text-gray-900 mb-2",

  subtitle:
    "text-gray-600 text-base sm:text-lg mb-6",

  /* Approved */
  approvedBox:
    "mt-4 border border-gray-200 rounded-xl p-6 text-left animate-fade-slide",
  ...
  primaryButton:
    "px-5 py-2.5 bg-gray-900 text-white rounded-xl text-sm font-medium hover:bg-gray-800 transition-colors",

  secondaryButton:
    "px-5 py-2.5 border border-gray-300 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors",

  /* Pending */
  pendingBox:
    "mt-4 bg-gray-50 border border-gray-200 rounded-xl p-5",
