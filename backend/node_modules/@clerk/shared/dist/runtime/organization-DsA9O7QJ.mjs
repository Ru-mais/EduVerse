...
import { eventMethodCalled } from "./telemetry-DoVTElgI.mjs";
...
const PaymentElement$1 = ({ fallback }) => {
	...
	return /* @__PURE__ */ React.createElement(PaymentElement, {
		fallback,
		onReady,
		options
	});
...
//#endregion
export { ClerkInstanceContext, ClientContext, OptionsContext, OrganizationProvider, PaymentElement$1 as PaymentElement, PaymentElementProvider, SessionContext, UserContext, __experimental_CheckoutProvider, __internal_usePaymentAttemptQuery, __internal_useStatementQuery, assertContextExists, createContextAndHook, getCurrentOrganizationMembership, isDeeplyEqual, useAPIKeys, useAssertWrappedByClerkProvider, useAttemptToEnableOrganizations, useCheckout, useClerk, useClerkInstanceContext, useClientContext, useDeepEqualMemo, useOptionsContext, useOrganization, useOrganizationContext, useOrganizationList, usePaymentAttempts, usePaymentElement, usePaymentMethods, usePlanDetailsQuery, usePlans, useReverification, useSafeLayoutEffect, useSession, useSessionContext, useSessionList, useStatements, useSubscription, useUser, useUserContext };
